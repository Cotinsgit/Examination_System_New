						...
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="selectCourse" id="form1" method="post">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="请输入课程" name="findByName">
							...
							<c:forEach  items="${courseList}" var="item">
								<tr>
									...
									<td>
										...
										<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='removeCourse?id=${item.courseid}'">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
						...
						<c:if test="${pagingVO != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									...
									<%--<li><a href="showCourse?page=${pagingVO.totalCount}">最后一页&raquo;</a></li>--%>
								</ul>
							</nav>
						</c:if>
				    </div>
