...
public class AdminController {
    ...
    public String passwordRestUI(PasswordRest passwordRest) throws Exception {
        Userlogin u = userloginService.findByName("admin");

        System.out.println(u.getPassword());
        System.out.println(passwordRest.getOldPassword());

        if(!u.getPassword().equals(passwordRest.getOldPassword())) {
            throw new CustomException("密码不正确！");
        }
        u.setPassword(passwordRest.getPassword1());
        userloginService.updateByName("admin", u);
        return "admin/passwordRest";
    }
